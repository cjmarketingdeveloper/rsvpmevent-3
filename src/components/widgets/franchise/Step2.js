...
function Step2({setStep, pharmacy, selectedEvent, setSelectedEvent, EVENTCODE, setProcessing}) {
    ...
    <div className="card-step">
        <div className="card p-4">
            <div className="info-orange">
                <p>{pharmacy.title}</p>
                <p><strong>{pharmacy.code}</strong></p>
            </div>
            <div className="mt-4">
              {
                listOfEvents &&
                  ...
                  <div className="event-list ">
                      {
                        listOfEvents.map((myEvent, index ) => {
                          ...
                          return <div className="event-item mb-3" key={index}>
                                      <button 
                                        type="button"
                                        className={`btn ${isSelected ? 'btn-selected' : 'btn-outline-plein'} btn-full`}
