...
function StepRegistrationConfirmed({person,pharmacy, hasSpouse, spouse}) {
            ...
            </div>
             {
                hasSpouse && (
                  <div className="info-gray mt-3 mb-2">
                      <div className="ops">
                          <div className="title-left">Phone:</div>
                          <div className="answr-right">{spouse.phonenumber}</div>
                      </div>
                      <div className="ops">
                          <div className="title-left">Name:</div>
                          <div className="answr-right">{spouse.name}</div>
                      </div>
                      <div className="ops">
                          <div className="title-left">Surname:</div>
                          <div className="answr-right">{spouse.surname}</div>
                      </div>
