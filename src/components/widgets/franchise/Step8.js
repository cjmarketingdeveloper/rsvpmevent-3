...
function Step8({setStep,  
            ...
            spGoingToTradeshow, setSpGoingToTradeshow, spGoingToGalaDiner, setSpGoingToGalaDiner,
            setProcessing
        }) {
        ...
        <div className="card p-4 minor-yellow">
            ...
            <div className="mb-3 mt-3 question-box">
                    ...
                    <div className="mb-3">
                        ...
                        <button 
                            type="button"
                            className={`btn ${spouseWorkingPharm ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                        ...
                        <button 
                            type="button"
                            className={`btn ${spouseWorkingPharm === false ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                     ...
                     {
                        spouseWorkingPharm && <div className="mb-4">
                                        <label>Designation*</label>
                                        <input type="text" className="form-control" onChange={(e) => setSpouseDesignation(e.target.value)} placeholder="Enter Role" />
                                    </div>
                    }
                   <div className="mb-3">
                        <label>Will you be attending Gala Dinner*</label>
                        
                        <button 
                            type="button"
                            className={`btn ${spGoingToGalaDiner ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => setSpGoingToGalaDiner(true)}
                            >
                            Yes
                        </button>
                        <button 
                            type="button"
                            className={`btn ${spGoingToGalaDiner === false ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => {
                                setSpGoingToGalaDiner(false);
                                }}
                            >
                            No
                        </button>
                    ...
                    <div className="mb-3">
                        <label>Will you be attending the Tradeshow*</label>
                        <button 
                            type="button"
                            className={`btn ${spGoingToTradeshow ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => setSpGoingToTradeshow(true)}
                            >
                            Yes
                        </button>
                        <button 
                            type="button"
                            className={`btn ${spGoingToTradeshow === false ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => {
                                setSpGoingToTradeshow(false);
                            }}
                            >
                            No
                        </button>
                    ...
                    <div className="mb-3 mt-3">
                        ...
                        <button 
                            type="button"
                            className={`btn ${spouseNeedFlight ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                        ...
                        <button 
                            type="button"
                            className={`btn ${spouseNeedFlight === false ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => {
                            ...
                            <div className="mb-3">
                                ...
                                <div className="custom-select-wrapper ">
                                    <select 
                                        ...
                                        defaultValue=""
                                        >
                                        <option value="" disabled hidden>Specify Flight</option>
