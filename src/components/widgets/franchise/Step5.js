...
function Step5({setStep,  
            ...
            goingToTradeshow, setGoingToTradeshow, goingToGalaDiner, setGoingToGalaDiner, questGalaKind
        }) {
                    ...
                    </div>
                    {
                        needFlight && (
                            <div className="mb-3">
                                ...
                                <div className="mt-3 mb-3 info-gray">
                                        Disclaimer: The attendee is responsible for 
                                        any costs related to missed flights or changes made after booking.    
                                     </div>
                            </div>
                        )
                    }
