    ...
    <div className="card-step">
        <div className="card p-4 minor-yellow">
            ...
            <div className="mb-3 mt-3 question-box">
                    <div className="mb-3">
                        <label>Are they a PCDT Pharmacist?</label>
                        <button 
                            type="button"
                            className={`btn ${spPcdtOption ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => setSPPCDTOption(true)}
                            >
                            Yes
                        </button>
                        <button 
                            type="button"
                            className={`btn ${!spPcdtOption ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                            onClick={() => setSPPCDTOption(false)}
                            >
                            No
                        </button>
                    </div>
                    {
                        spPcdtOption && (<div className="mb-3">
                            <label>Will they be attending the Clinic conference?</label>
                                    <button 
                                        type="button"
                                        className={`btn ${spouseClinicEvent ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                                        onClick={() => setSpouseClinicEvent(true)}
                                        >
                                        Yes
                                    </button>
                                    <button 
                                        type="button"
                                        className={`btn ${!spouseClinicEvent ? 'btn-selected' : 'btn-outline-simple'} btn-full mb-3`}
                                        onClick={() => setSpouseClinicEvent(false)}
                                        >
                                        No
                                    </button>
                              </div>)
                    ...
                    <div className="mb-3">
                        ...
                        <button 
                            ...
                            onClick={() => setSpGoingToGalaDiner(false)}
                            >
                            No
                        </button>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <button 
                            ...
                            onClick={() => setSpGoingToTradeshow(false)}
                            >
                            No
                        </button>
                    </div>
