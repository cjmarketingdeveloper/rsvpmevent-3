...
function StepAccomodation({setStep,  
        ...
        setAccomodationType, setSpouseAccomodationType, 
        setPersonSpecialAccomodation
    }) {
    ...
    <div className="card-step">
        <div className="card p-4">
            ...
            <div className="mb-3 mt-3 question-box">
                ...
                <button 
                    type="button"
                    className={`btn ${!personAccomodation ? 'btn-selected' : 'btn-outline-simple'} btn-full`}
            ...
            <div className="mb-3">
                <label>Any special accommodation requirements?</label>
                <textarea className="form-control" onChange={(e) => setPersonSpecialAccomodation(e.target.value)}>
                </textarea>
             </div>
            { /*
                hasSpouse && (
                   <>
                     <div className="mb-3 mt-2">
                        ...
                        <button 
                                type="button"
                                className={`btn ${spouseAccomodation ? 'btn-selected' : 'btn-outline-black'} btn-full mb-3`}
                            ...
                            <button 
                                type="button"
                                className={`btn ${!spouseAccomodation ? 'btn-selected' : 'btn-outline-black'} btn-full`}
...

                         {
                            spouseAccomodation && (
                                <div className="mb-3">
                                    ...
                                    <div className="mt-3 info-gray">
                            Notice: Single accomodation will be charged on to the attendees own account.</div>
                                </div>
                                )
                        }
                   </>
